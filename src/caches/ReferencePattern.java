...
public class ReferencePattern {
   ...
   public int hitNode = -2; 
    ...
    public String toString() {
        return "ReferencePattern{" + "node_id=" + node_id + ", timestamp=" + timestamp + ", object=" + object + ", status=" + status + ", object_id=" + object_id + ", child_id=" + childID + ", parent_id=" + parent_id + ", hitNode=" + hitNode + ", client_id="  + '}';
    }
